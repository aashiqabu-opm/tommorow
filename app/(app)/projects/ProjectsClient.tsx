...
import { Plus, Clapperboard, TrendingUp, TrendingDown } from 'lucide-react'
...
const INITIAL_FORM = { name: '', status: 'development', description: '', start_date: '', end_date: '', budget: '' }
        ...
        {projects.map((project) => {
          ...
          return (
            <Link key={project.id} href={`/projects/${project.id}`}>
              <div className="bg-[#13131a] border border-[#2a2a3a] rounded-2xl p-5 hover:border-white/30 hover:bg-[#16161f] transition-all cursor-pointer group h-full flex flex-col">
